...
import com.example.ecommit.Model.Cart;
import com.example.ecommit.Prevalent.Prevalent;
import com.example.ecommit.R;
import com.example.ecommit.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMsg1 = (TextView) findViewById(R.id.msgl);
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Congratulations, your final order has been Shipped successfully. Soon you will received your order at your doo step");
